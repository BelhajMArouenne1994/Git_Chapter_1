...
type SimpleFilterPart struct {
	*FilterPart
	...
	SimpleOperator *SimpleOperators `xml:"SimpleOperator,omitempty"`
...
type Subscriber struct {
	*APIObject
	...
	UnsubscribedDate time.Time `xml:"UnsubscribedDate,omitempty"`

	Status *SubscriberStatus `xml:"Status,omitempty"`

	PartnerType string `xml:"PartnerType,omitempty"`

	EmailTypePreference *EmailType `xml:"EmailTypePreference,omitempty"`

	Lists []*SubscriberList `xml:"Lists,omitempty"`

	GlobalUnsubscribeCategory *GlobalUnsubscribeCategory `xml:"GlobalUnsubscribeCategory,omitempty"`

	SubscriberTypeDefinition *SubscriberTypeDefinition `xml:"SubscriberTypeDefinition,omitempty"`

	Addresses struct {
		Address []*SubscriberAddress `xml:"Address,omitempty"`
	} `xml:"Addresses,omitempty"`

	PrimarySMSAddress *SMSAddress `xml:"PrimarySMSAddress,omitempty"`

	PrimarySMSPublicationStatus *SubscriberAddressStatus `xml:"PrimarySMSPublicationStatus,omitempty"`

	PrimaryEmailAddress *EmailAddress `xml:"PrimaryEmailAddress,omitempty"`
...
type DataExtensionField struct {
	*PropertyDefinition
	...
	IsPrimaryKey bool `xml:"IsPrimaryKey,omitempty"`

	FieldType *DataExtensionFieldType `xml:"FieldType,omitempty"`

	DataExtension *DataExtension `xml:"DataExtension,omitempty"`

	StorageType *DataExtensionFieldStorageType `xml:"StorageType,omitempty"`
}
